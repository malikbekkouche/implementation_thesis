class Main {
	public static void main(String[] args){
		...
		System.out.println("-------------------------------");
		System.out.println("update "+tree.put(6,66));
		System.out.println("-------------------------------");
		System.out.println("snap "+snap.get(6));
		System.out.println("-------------------------------");
		System.out.println("tree "+tree.get(6));
		System.out.println("-------------------------------");
		System.out.println("update "+tree.put(6,666));
		System.out.println("-------------------------------");
		System.out.println("snap "+snap.get(6));
		System.out.println("-------------------------------");
		System.out.println("tree "+tree.get(6));
		System.out.println("-------------------------------");
		System.out.println("update "+tree.put(15,15));
		System.out.println("-------------------------------");
